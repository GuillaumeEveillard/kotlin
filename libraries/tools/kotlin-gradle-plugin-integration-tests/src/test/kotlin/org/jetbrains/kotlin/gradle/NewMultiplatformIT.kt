...
class NewMultiplatformIT : BaseGradleIT() {
    ...
    private fun doCommonNativeTest(
        ...
        // TODO: Disable linking from sources when KT-34180 is fixed.
        build(":lib:publish", "-Pkotlin.native.linkFromSources") {
            assertSuccessful()
        ...
        build(":app:build", *appLinkTestTasks.toTypedArray(), "-Pkotlin.native.linkFromSources") {
            assertSuccessful()
